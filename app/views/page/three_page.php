<?php $this->layout('template/template', ['title' => 'Three Page']) ?>
...
<?php $this->end() ?>
    ...
    <div class="row text-center bg-light mb-5 p-5">
        <div class="col">
            <form action="/openOnePage" class="mb-3" method="GET">
                <div class="row justify-content-center">
                    <div class="form-group col-4">
                        <p class="h3 mb-5">Результаты</p>
                        <button type="submit" class="btn btn-secondary btn-lg">Начать заново</button>
                    </div>
                </div>
            </form>
